...
//  18 - alerts.decline_kind: why a decline happened. 'invalid' means the rung
//       should not have fired and must not count as hit; 'judgement' means it
//       was right and the user decided otherwise -- an execution gap on a real
//       position, and a finding about the RULE on a paper one
//  19 - cash_transactions: contributions, withdrawals and opening balances.
//       Cash is otherwise derived from the trade ledger, but without the
//       boundary-crossing movements no account can be reconciled to a broker --
//       the IRA's positions matched to $13 while its total was out by $4,797.73
